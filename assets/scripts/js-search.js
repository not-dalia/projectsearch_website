!function(root, factory) {
  ...
  return function(modules) {
      ...
      __webpack_require__(__webpack_require__.s = 17);
  }([/* 0 */
  /***/
  function(module, exports, __webpack_require__) {
      ...
      var _AllSubstringsIndexStrategy = __webpack_require__(7);
      ...
      var _ExactWordIndexStrategy = __webpack_require__(8);
      ...
      var _PrefixIndexStrategy = __webpack_require__(9);
  ...
  function(module, exports, __webpack_require__) {
      ...
      var _CaseSensitiveSanitizer = __webpack_require__(10);
      ...
      var _LowerCaseSanitizer = __webpack_require__(11);
  ...
  function(module, exports, __webpack_require__) {
      ...
      var _TfIdfSearchIndex = __webpack_require__(12);
      ...
      var _UnorderedSearchIndex = __webpack_require__(13);
  ...
  function(module, exports, __webpack_require__) {
      ...
      StopWordsMap.constructor = !1,
      StopWordsMap.hasOwnProperty = !1,
      StopWordsMap.isPrototypeOf = !1,
      StopWordsMap.propertyIsEnumerable = !1,
      StopWordsMap.toLocaleString = !1,
      StopWordsMap.toString = !1,
...
*/
      function getNestedFieldValue(object, path) {
          ...
          for (var value = object, i = 0; i < path.length; i++)
      ...
      var _createClass = function() {
        ...
        , _index2 = __webpack_require__(1)
        , _index3 = __webpack_require__(2)
        , _index4 = __webpack_require__(4);
   ...
   */
              ...
              value: function(documents, _searchableFields) {
                  ...
                  for (var indexStrategy = this._indexStrategy, sanitizer = this._sanitizer, searchIndex = this._searchIndex, tokenizer = this._tokenizer, uidFieldName = this._uidFieldName, di = 0, numDocuments = documents.length; di < numDocuments; di++)
                      for (var doc = documents[di], uid = doc[uidFieldName], sfi = 0, numSearchableFields = _searchableFields.length; sfi < numSearchableFields; sfi++) {
                          var fieldValue, searchableField = _searchableFields[sfi];
                          if (fieldValue = searchableField instanceof Array ? getNestedFieldValue(doc, searchableField) : doc[searchableField],
                          null != fieldValue && "string" != typeof fieldValue && fieldValue.toString && (fieldValue = fieldValue.toString()),
                          "string" == typeof fieldValue)
                              for (var fieldTokens = tokenizer.tokenize(sanitizer.sanitize(fieldValue)), fti = 0, numFieldValues = fieldTokens.length; fti < numFieldValues; fti++)
                                  for (var fieldToken = fieldTokens[fti], expandedTokens = indexStrategy.expandToken(fieldToken), eti = 0, nummExpandedTokens = expandedTokens.length; eti < nummExpandedTokens; eti++) {
 ...
 */
          return _createClass(TokenHighlighter, [{
              ...
              value: function(text, tokens) {
                  ...
                  for (var tagsLength = this._wrapText("").length, tokenDictionary = {}, i = 0, numTokens = tokens.length; i < numTokens; i++)
                      for (var token = this._sanitizer.sanitize(tokens[i]), expandedTokens = this._indexStrategy.expandToken(token), j = 0, numExpandedTokens = expandedTokens.length; j < numExpandedTokens; j++) {
                  ...
                  for (var actualCurrentWord = "", sanitizedCurrentWord = "", currentWordStartIndex = 0, i = 0, textLength = text.length; i < textLength; i++) {
                      ...
                      " " === character ? (actualCurrentWord = "",
                      sanitizedCurrentWord = "",
                      currentWordStartIndex = i + 1) : (actualCurrentWord += character,
                      sanitizedCurrentWord += this._sanitizer.sanitize(character)),
                      tokenDictionary[sanitizedCurrentWord] && tokenDictionary[sanitizedCurrentWord].indexOf(sanitizedCurrentWord) >= 0 && (actualCurrentWord = this._wrapText(actualCurrentWord),
   ...
   */
              value: function(token) {
                  for (var expandedTokens = [], string = "", i = 0, length = token.length; i < length; ++i)
 ...
 */
          return _createClass(TfIdfSearchIndex, [{
              ...
              value: function(token, uid, doc) {
                  ...
                  "object" !== _typeof(uidMap[uid]) ? (tokenDatum.$numDocumentOccurrences++,
                  uidMap[uid] = {
                      $document: doc,
              ...
              value: function(tokens, corpus) {
                  for (var uidToDocumentMap = {}, i = 0, numTokens = tokens.length; i < numTokens; i++) {
                      var token = tokens[i]
                        , tokenMetadata = this._tokenMap[token];
                      // Short circuit if no matches were found for any given token.
                      if (!tokenMetadata)
                          //return [];
                          continue;
                      if (0 === i)
                          for (var keys = Object.keys(tokenMetadata.$uidMap), j = 0, numKeys = keys.length; j < numKeys; j++) {
                              var uid = keys[j];
                              uidToDocumentMap[uid] = tokenMetadata.$uidMap[uid].$document;
                          }
                      else
                          for (var keys = Object.keys(uidToDocumentMap), j = 0, numKeys = keys.length; j < numKeys; j++) {
                              var uid = keys[j];
                  ...
                  var calculateTfIdf = (this._tokenMap,
                  this._tokenToIdfCache,
                  this._uidFieldName,
                  this._createCalculateTfIdf());
              ...
              value: function() {
                  var tokenMap = this._tokenMap
                    , tokenToIdfCache = this._tokenToIdfCache;
              ...
              value: function() {
                  var tokenMap = this._tokenMap
                    , uidFieldName = this._uidFieldName
                    , calculateIdf = this._createCalculateIdf();
                  return function(tokens, document, documents) {
                      for (var score = 0, i = 0, numTokens = tokens.length; i < numTokens; ++i) {
                          var token = tokens[i]
                            , inverseDocumentFrequency = calculateIdf(token, documents);
                          inverseDocumentFrequency === 1 / 0 && (inverseDocumentFrequency = 0);
                          var uid = document && document[uidFieldName]
                            , termFrequency = "undefined" != typeof tokenMap[token] && "undefined" != typeof tokenMap[token].$uidMap[uid] ? tokenMap[token].$uidMap[uid].$numTokenOccurrences : 0;
          ...
          return _createClass(UnorderedSearchIndex, [{
              ...
              value: function(tokens, corpus) {
                  for (var intersectingDocumentMap = {}, tokenToUidToDocumentMap = this._tokenToUidToDocumentMap, i = 0, numTokens = tokens.length; i < numTokens; i++) {
                      var token = tokens[i]
                        , documentMap = tokenToUidToDocumentMap[token];
                      // Short circuit if no matches were found for any given token.
                      if (!documentMap)
                          return [];
                      if (0 === i)
                          for (var keys = Object.keys(documentMap), j = 0, numKeys = keys.length; j < numKeys; j++) {
                              var uid = keys[j];
                              intersectingDocumentMap[uid] = documentMap[uid];
                          }
                      else
                          for (var keys = Object.keys(intersectingDocumentMap), j = 0, numKeys = keys.length; j < numKeys; j++) {
                              var uid = keys[j];
 ...
 */
          return _createClass(StemmingTokenizer, [{
              key: "tokenize",
              value: function(text) {
                  return [...this._tokenizer.tokenize(text), ...this._tokenizer.tokenize(text).map(this._stemmingFunction)];
              }
          }]),
          StemmingTokenizer;
      }();
 ...
 */
  ...
  function(module, exports, __webpack_require__) {
      ...
      var _TokenHighlighter = __webpack_require__(6);
